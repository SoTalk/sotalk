...
// WalletDTO represents wallet data
...
// TokenBalanceDTO represents token balance data
...
// TransactionMetadataDTO represents transaction metadata
...
// WalletResponse is the response for single wallet operations
type WalletResponse struct {
	Wallet WalletDTO `json:"wallet"`
}

// WalletsResponse is the response for multiple wallets
type WalletsResponse struct {
	Wallets []WalletDTO `json:"wallets"`
	Total   int         `json:"total"`
}

// TransactionResponse is the response for single transaction
type TransactionResponse struct {
	Transaction TransactionDTO `json:"transaction"`
}

// TransactionsResponse is the response for multiple transactions
type TransactionsResponse struct {
	Transactions []TransactionDTO `json:"transactions"`
	Total        int              `json:"total"`
}

// AirdropResponse is the response for airdrop request
